        ...
        <Form {...loginform}>
            <form className={cn("flex flex-col gap-6", className)} onSubmit={loginform.handleSubmit(onSubmit)} {...props}>
                ...
                <div className="grid gap-6">
                    ...
                    <Button variant="outline" className="w-full" type="button" role="button" disabled={isPending || loginform.formState.isSubmitting} onClick={() => signInGithub()}>
                    ...
                    <Button variant="outline" className="w-full" type="button" role="button" disabled={isPending || loginform.formState.isSubmitting} onClick={() => signInGoogle()}>
